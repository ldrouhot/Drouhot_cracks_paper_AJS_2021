...
TeO.full.2 <- TeO.full %>% filter(missing==0 & native==0)
...
clustering_error$variable <- as.character(clustering_error$variable) # renaming  the varibles appropriately
							...
							clustering_error[14,1] <- "Empirical SD: Prop. reporting high importance of religion in parental education"
							clustering_error[15,1] <- "Empirical SD: Prop. reporting transnational ties"
							clustering_error[16,1] <- "Empirical SD: Prop. living in top decile for % of North African immigrants"
							clustering_error[17,1] <- "Empirical SD: Prop. living in top decile for % of Sub-S African immigrants"
							clustering_error[18,1] <- "Empirical SD: Count"
...
clustering_var_grand_means$variable <- as.character(clustering_var_grand_means$variable)
							...
							clustering_var_grand_means[28,1] <- "Grand mean: reporting high importance of religion in parental education"
							clustering_var_grand_means[29,1] <- "Grand SD: reporting high importance of religion in parental education"
							clustering_var_grand_means[30,1] <- "Grand mean: Prop. reporting transnational ties"
							clustering_var_grand_means[31,1] <- "Grand SD: Prop. reporting transnational ties"
							clustering_var_grand_means[32,1] <- "Grand mean: Prop. living in top decile for % of North African immigrants"
							clustering_var_grand_means[33,1] <- "Grand SD: Prop. living in top decile for % of North African immigrants"
							clustering_var_grand_means[34,1] <- "Grand mean: Prop. living in top decile for % of Sub-S African immigrants"
							clustering_var_grand_means[35,1] <- "Grand SD: Prop. living in top decile for % of Sub-S African immigrants"
							clustering_var_grand_means[36,1] <- "Grand count"
